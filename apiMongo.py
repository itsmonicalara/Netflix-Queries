...
if __name__ == '__main__':
	...
	add_tvShow("The SpongeBob Series", "Tim Hill", "Tom Kenny", "United States", "November 22, 2020", "2020", "A", "91 min", "Comedy", "Live/Action film based on the animated television series SpongeBob SquarePants.")
